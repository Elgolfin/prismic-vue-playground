<!-- Create file src/components/Page.vue -->
...
<template>
  <div class="wrapper">
    ...
    <div v-html="fields.customHtml"></div>
    <div class="icon-wrapper" v-if="fields.icon.url">
      ...
      this.$prismic.client.getByUID('page', uid)
        .then((document) => {
          if (document) {
            ...
            this.fields.customHtml = document.data.custom_html
            console.log("test")
            console.log(document.data.icon.url)
          } else {
